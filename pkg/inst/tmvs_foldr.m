...
%!error
%! tmvs_foldr (g, struct ('1', {}, '2', {}));
%!test
%! assert (tmvs_foldr (g, struct ('1', {}, '2', {}), 2), 2);

%!test
%! assert (tmvs_foldr (g, struct ('1', {3}, '2', {6}), 6), 2);

%!test
%! assert (tmvs_foldr (g, struct ('1', {3, 6}, '2', {6, 12}), 36), 2);
%!test
%! assert (tmvs_foldr (g, struct ('1', {3; 6}, '2', {6; 12}), 36), 2);

%!test
%! assert (tmvs_foldr (g, struct ('1', {3, 6; 36, 1296}, ...
