...
%
% Parse a name into an identifier and metadata container.
%
% Parses the string @var{str} containing a record name and
% produces the identifying structure @var{id} and
% the metadata container @var{meta}.
% A formal grammar for the parser
% is presented in the ANTLR 4 grammar file @file{Name.g4}.
%
...
% @result{} id = struct ( ...
% @result{}   'source', 1, 'quantity', 2, 'site', 16, ...
% @result{}   'surface', 1, 'room', 120, 'section', 1, 'ordinal', 1)
% @result{} meta = struct ('position', 180, 'material', 3)
% @end example
%
% @example
