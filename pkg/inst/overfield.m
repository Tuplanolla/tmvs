...
% (modify, over or zoom for lenses).
%
...
%!test
%! assert (overfield (f, struct ('1', {-1}, '2', {1}), '1'), ...
%!         struct ('1', {1}, '2', {1}));
%!test
%! assert (overfield (f, struct ('1', {-1}, '2', {1}), '2'), ...
%!         struct ('1', {-1}, '2', {-1}));


%!test
%! assert (overfield (f, struct ('1', {-2, -1}, '2', {1, 2}), '1'), ...
%!         struct ('1', {2, 1}, '2', {1, 2}));
%!test
%! assert (overfield (f, struct ('1', {-2, -1}, '2', {1, 2}), '2'), ...
%!         struct ('1', {-2, -1}, '2', {-1, -2}));
...
%!test
%! assert (overfield (f, struct ('1', {-4, -3; -2, -1}, ...
%!                               '2', {1, 2; 3, 4}), '1'), ...
